...
## Prompt Paso 3.1 — Crear servicios HTTP (Angular 19)
...
|------|---------|-------------|
| 3.1 | `src/environments/environment.ts` | URLs de los servicios |
| 3.1 | `src/app/models/restaurante.model.ts` | Interface Restaurante |
| 3.1 | `src/app/models/producto-menu.model.ts` | Interface ProductoMenu |
| 3.1 | `src/app/models/deliver.model.ts` | Interface Deliver |
| 3.1 | `src/app/services/restaurante.service.ts` | Servicio HTTP restaurantes |
| 3.1 | `src/app/services/deliver.service.ts` | Servicio HTTP delivers |
| 3.2 | `src/app/components/mapa/mapa.component.ts` | Componente Canvas del mapa |
| 3.3 | `src/app/components/menu-modal/menu-modal.component.ts` | Modal del menú |
| 3.4 | `src/app/app.component.ts` | Integración de componentes |
...
|------|-------------|--------|
| 3.1 | Servicios HTTP y modelos | ⏳ Pendiente |
