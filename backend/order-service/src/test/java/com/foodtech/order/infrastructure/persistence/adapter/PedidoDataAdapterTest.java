...
public class PedidoDataAdapterTest {
    ...
    void debeGuardarYPasarARepository_cuandoPedidoValido() {
        ...
        Pedido pedido = new Pedido(100L, EstadoPedido.PENDIENTE, 10L, List.of(prod), 20L, "Cliente", 1.0, 2.0, 15);

        PedidoEntity returned = new PedidoEntity(100L, EstadoPedido.PENDIENTE, 10L, 20L, "Cliente", 1.0, 2.0, 15, "[{\"id\":1,\"nombre\":\"Pizza\",\"precio\":null}]");
    ...
    void debeMapearDesdeRepository_cuandoExiste() {
        PedidoEntity entity = new PedidoEntity(200L, EstadoPedido.ASIGNADO, 30L, 40L, "C", 1.0, 2.0, 20, "[]");
